///
/// Created by Auro (aurosmruti@smarttersstudio.com) on 25/1/21 at 10:43 PM
///
...
class StickyHeadersTable extends StatefulWidget {
  ...
  final BoxDecoration Function(int rowIndex) columnTitleDecoration;
  final BoxDecoration Function(int rowIndex) rowTitleDecoration;
  final BoxDecoration Function(int columnIndex, int rowIndex) cellDecoration;
  final BoxDecoration legendCellDecoration;
        ...
        Row(
          children: <Widget>[
            ...
            Container(
              ...
              // height: widget.cellDimensions.stickyLegendHeight - 40,
              height: widget.columnTitleHeight ?? 60,
              alignment: widget.cellAlignments.stickyLegendAlignment,
              child: FittedBox(
                fit: widget.cellFit,
                child: widget.legendCell,
              ),
              decoration: widget.legendCellDecoration,
            ),
            // STICKY ROW
            Expanded(
                  ...
                  child: Row(
                    ...
                    children: List.generate(
                      ...
                      (i) => Container(
                        ...
                        decoration: widget.columnTitleDecoration == null
                            ? null
                            : widget.columnTitleDecoration(i),
                      ),
                    ),
                  ),
                  ...
                  child: Column(
                    children: List.generate(
                      ...
                      (i) => Container(
                        ...
                        decoration: widget.rowTitleDecoration == null
                            ? null
                            : widget.rowTitleDecoration(i),
                      ),
                    ),
                  ),
