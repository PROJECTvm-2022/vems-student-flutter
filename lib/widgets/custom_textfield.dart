///
/// Created by Auro (aurosmruti@smarttersstudio.com) on 6/1/21 at 10:54 AM
///
...
/// implementation of [MyCustomTextField], that allows the value to be saved,
/// validated, etc.
///
/// See also:
///
/// * [MyCustomTextField], A [TextField](https://docs.flutter.io/flutter/material/TextField-class.html)
/// that displays a list of suggestions as the user types
class MyCustomFormField<T> extends FormField<String> {
  /// The configuration of the [TextField](https://docs.flutter.io/flutter/material/TextField-class.html)
  /// that the TypeAhead widget displays
  final TextFieldConfiguration textFieldConfiguration;

  /// Creates a [MyCustomFormField]
  MyCustomFormField(
      {Key key,
      String initialValue,
...
class _TypeAheadFormFieldState<T> extends FormFieldState<String> {
  ...
  @override
  MyCustomFormField get widget => super.widget;
  ...
  @override
  void didUpdateWidget(MyCustomFormField oldWidget) {
...
/// See also:
///
/// * [MyCustomFormField], a [FormField](https://docs.flutter.io/flutter/widgets/FormField-class.html)
/// implementation of [MyCustomTextField] that allows the value to be saved,
/// validated, etc.
class MyCustomTextField<T> extends StatefulWidget {
  ...
  final GlobalKey editableTextKey;

  /// Creates a [MyCustomTextField]
  MyCustomTextField(
      {Key key,
  ...
  @override
  _MyCustomTextFieldState<T> createState() => _MyCustomTextFieldState<T>();
}

class _MyCustomTextFieldState<T> extends State<MyCustomTextField<T>>
  ...
  // Will have a value if the type ahead is inside a scrollable widget
  ScrollPosition _scrollPosition;
  final KeyboardVisibilityController keyboardVisibilityController =
      KeyboardVisibilityController();

  // Keyboard detection
  Stream<bool> _keyboardVisibility;
  ...
  void initState() {
    ...
    _keyboardVisibility = keyboardVisibilityController.onChange;
    if (widget.textFieldConfiguration.controller == null) {
    ...
    return CompositedTransformTarget(
      ...
      child: TextField(
        ...
        maxLengthEnforcement:
            widget.textFieldConfiguration.maxLengthEnforced == true
...
class _SuggestionsListState<T> extends State<_SuggestionsList<T>>
  ...
  @override
  Widget build(BuildContext context) {
    if (_suggestions == null && _isLoading == false) return Container();
...
class _SuggestionsBox {
  ...
  Future<bool> _waitChangeMetrics() async {
    if (widgetMounted) {
      ...
      while (widgetMounted && timer < waitMetricsTimeoutMillis) {
        // TODO(Sunil): reduce delay if showDialog ever exposes detection of animation end
  ...
  void _adjustMaxHeightAndOrientation() {
    MyCustomTextField widget = context.widget as MyCustomTextField;
